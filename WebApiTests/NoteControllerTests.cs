...
public class NoteControllerTests
{
    ...
    public void Create_ReturnsCreatedNote_WhenModelIsValid()
    {
        ...
        var result = _controller.Create(new NoteCreate { Title = "New Note", Text = "New content", CategoryId = 1 });
    ...
    public void Update_ReturnsUpdatedNote_WhenModelIsValid()
    {
        ...
        var result = _controller.Update(new NoteUpdate { Id = 1, Title = "Updated Note", Text = "Updated content", CategoryId = 1 });
