...
public class CategoryControllerTests
{
    ...
    public void Create_ReturnsCreatedCategory_WhenModelIsValid()
    {
        ...
        var result = _controller.Create(new CategoryCreate { Name = "New Category" });
    ...
    {
        var updatedCategory = new Category { Id = 2, Name = "Updated Name", UserId = 1 };
        _mockCategoryService.Setup(s => s.Update(It.IsAny<Category>())).Returns(updatedCategory);

        var result = _controller.Update(new CategoryUpdate { Id = 2, Name = "Updated Name" });
